...
NewsApp uses [NewsAPI](https://newsapi.org/) to fetch top news headlines from the API. This app also includes Room DB you can add news or delete it from locale storage.
